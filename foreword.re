...
ともあれ、消費者ソフトウェアの信頼性が改善されるにつれて、消費者の嗜好の一歩先を歩き続けるレースは、アプリケーション開発者を金銭的利害にますます縛りつけるようになった。私はハッカー精神がもはや存在しないとか、少しでも弱まったと言っているのではない。ただ、キーワードがスポンサーのページを指すように "info" ページを書き換え、起動時に八割の率でセマンティックエラーを引き起こすようなフェイスブックのアルゴリズムを作ったプログラマは、新車のポルシェで多くの時間を費やしながら、「スーツ」が邪魔しなければプログラムが本当は達成しえたはずのことについて不満を鳴らしているのではないか、と言っているのだ。
