...
<blockquote><p class="quotation">今年の感謝祭から、私は Unix と完全に互換性のあるソフトウェアシステム、GNU（Gnu's Not Unix; Gnu は Unix に非ず）を書き始めます。
...
<blockquote><p class="quotation">私はリチャード・ストールマンです。たくさん模倣されたオリジナル EMACS エディタの考案者で、今は MIT の人工知能研究所にいます。コンパイラ、エディタ、デバッガ、コマンドインタプリタ、非互換時分割システム（ITS）や Lisp マシン・オペレーティング・システムについて広く取り組んできました。ITS 端末の独立ディスプレイのサポートを開拓し、Lisp マシンにクラッシュ耐性ファイルシステムを一つ、ウィンドウシステムを二つ実装しました。3
</blockquote>
...
1950 年代後期の MIT の人工知能研究者の一人で、人工知能研究のパイオニアであるジョン・マッカーシー（John <span class="noexists">McCarthy<a href="http://haleakala-avenue.style.coocan.jp/lealea/?cmd=edit&amp;page=McCarthy&amp;refer=%E7%AC%AC%E4%B8%83%E7%AB%A0%E3%80%80%E7%8E%87%E7%9B%B4%E3%81%AA%E9%81%93%E5%BE%B3%E7%9A%84%E9%81%B8%E6%8A%9E">?</a></span>）がつくった Lisp（リスプ）はエレガントな言語で、不規則な構造のデータを操作する複雑なプログラムを書くのに適している。この言語の名前は LISt Processing（リスト・プロセッシング）を略したものだ。マッカーシーがスタンフォード大学人工知能研究所へ転任するのに伴い、MIT のハッカーたちはこの言語を磨き上げて MACLISP という名の方言を作り出した。MAC とは、DARPA より資金提供され、AI ラボとコンピュータ・サイエンス研究所を創設することになった研究プロジェクト、プロジェクト MAC のことを指している。AI ラボの大物ハッカー、リチャード・グリーンブラットを先頭に、1970 年代後期の AI ラボのプログラマたちは、Lisp が効率的で都合良く走ることに特化したコンピュータ、Lisp マシンを設計し、そのための完全に Lisp ベースのオペレーティング・システムを開発した。
...
<blockquote><p class="quotation">ストールマンが書いたものを見て、それは駄目だと決めつけることができたかもしれません（おそらく違うが、誰かがそれは駄目だと信じ込ませることができたかもしれない）。そうだとしても、「しかし、ちょっと待った。あちらじゃ、ストールマンは一晩中誰とも議論していないんだ。一人で働いているんだぜ！これを一人でやれるなんてことは信じられない！」と言ったでしょう。16
</blockquote>
...
<blockquote><p class="quotation">もしも、私が私自身のためにいるのでなければ、誰が私のためにいるのだろうか。もしも、私が私自身のためにのみいるのだというなら、私は何なのだろうか。もしも、今でなければ、いつだというか。12
</blockquote>
...
<a href="http://catb.org/jargon/html/T/TWENEX.html" rel="nofollow">http://catb.org/jargon/html/T/TWENEX.html</a>

8 <a href="http://www.as.cmu.edu/" rel="nofollow">http://www.as.cmu.edu/</a> geek/humor/See_Figure_1.txt. <br />

9  リチャード・ストールマン（1986年）参照。

10『MIT AI ラボの観光客ポリシー』を参照。

<a href="http://www.art.net/" rel="nofollow">http://www.art.net/</a> hopkins/Don/text/ ~ tourist-policy.html
...
<a href="http://en.wikipedia.org/wiki/Open_Letter_" rel="nofollow">http://en.wikipedia.org/wiki/Open_Letter_</a> to_Hobbyists.

18 次を参照。ストールマンはこの声明に脚注を加えて、「無神論者の一人として、宗教指導者に従うことはないが、彼らの中の或る者が述べた言葉に感心している自分に気付くことがある。」と書いている。

<a href="http://www.gnu.org/gnu/the-gnu-project.html." rel="nofollow">http://www.gnu.org/gnu/the-gnu-project.html.</a>
...
<a href="http://www.gnu.org/gnu/" rel="nofollow">http://www.gnu.org/gnu/</a> manifesto.html
