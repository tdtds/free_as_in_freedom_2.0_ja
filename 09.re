...
<blockquote><p class="quotation">Copyright (c) 1985, ラリー・ウォール<br />
...
<blockquote><p class="quotation">たぶん、ライセンスから「EMACS」を削除し、「ソフトウェア」とか何か別の名前で置き換えるべきです。遠からず、と希望しますが、Emacs は GNU システムの一番大きな部分ではなくなり、このライセンスが GNU システム全体に適用されることになるでしょうから。3
</blockquote>
...
<blockquote><p class="quotation">GNU 一般公衆ライセンスは、以下のことを保証するるように設計されています。
...
ストールマンが構想した完全な GNU オペレーティング・システムはソフトウェア開発ツール以上のものを必要としていた。1990 年代に、GNU はコマンドライン・インタープリター、すなわち、「シェル（Shell）」も開発した。それはボーン・シェルを拡大し、置き換えたものだ（FSF の職員のブライアン・フォックス（Brian Fox）が書き、ストールマンが Bourne Again Shell すなわち BASH と命名）。<span class="noexists">PostScript<a href="http://haleakala-avenue.style.coocan.jp/lealea/?cmd=edit&amp;page=PostScript&amp;refer=%E7%AC%AC%E4%B9%9D%E7%AB%A0%E3%80%80GPL">?</a></span> のインタープリターの Ghostscript、文書ブラウザ・プラットフォームの Texinfo、プログラムを走らせ、システム・カーネルとやりとりするために C 言語のプログラムが必要とする C Library、表計算ソフトの Oleo（「高価な表計算ソフトより健康志向の」）があり、さらに、かなり良いチェス・ゲームさえあった。しかし、たいていプログラマは、GNU プログラミング・ツールに最も関心があった。
...
1990 年に、マッカーサー財団（the John D. and Catherine T. <span class="noexists">MacArthur<a href="http://haleakala-avenue.style.coocan.jp/lealea/?cmd=edit&amp;page=MacArthur&amp;refer=%E7%AC%AC%E4%B9%9D%E7%AB%A0%E3%80%80GPL">?</a></span> Foundation）がストールマンにマッカーサー・フェローシップを与えることで、彼を天才と認定したことから、ストールマンはいわゆる「ジーニアス(天才)助成金」を受け取ることになったが、この場合には 5 年間で総計 24 万ドルだった。財団は受賞理由の声明を出さなかったが、これは GNU プロジェクトを立ち上げ、自由ソフトウェアの哲学を提唱したことに贈られたものとして理解された。賞金はストールマンを当面の幾つかの心配事から解放した。たとえば、それは 80 年代に彼の収入源だったコンサルティングの仕事をやめて自由ソフトウェアの大義にもっと専念することを可能にした。
...
<blockquote><p class="quotation">minix を使っているみなさん、こんにちは。
</blockquote>
<blockquote><p class="quotation">いま 386 (486) 互換機用に（自由な）オペレーティング・システムを作っています
...
<blockquote><p class="quotation">人生の半年をこれに費やし、それを使えるものにし、
...
<a href="http://groups.csail.mit.edu/mac/classes/" rel="nofollow">http://groups.csail.mit.edu/mac/classes/</a> 6.805/articles/int-prop/software-copyright.html

2. trn キットの README を参照。

<a href="http://stuff.mit.edu/afs/sipb/project/trn/src/" rel="nofollow">http://stuff.mit.edu/afs/sipb/project/trn/src/</a> trn-3.6/README

3. ジョン・ギルモアの著者への e メールから引用。

4 リチャード・ストールマン他、『GNU一般公衆ライセンス 第１版』(1989年2月) を参照。

<a href="http://www.gnu.org/licenses/old-licenses/gpl-1.0.html" rel="nofollow">http://www.gnu.org/licenses/old-licenses/gpl-1.0.html</a>
...
<a href="http://www.gnu.org/gnu/byte-interview.html)" rel="nofollow">http://www.gnu.org/gnu/byte-interview.html)</a>
...
BSD ライセンスが抱える問題参照。<a href="http://www.gnu.org/philosophy/bsd.ja.html" rel="nofollow">http://www.gnu.org/philosophy/bsd.ja.html</a>
...
<a href="http://www.gnu.org/software/hurd/history.html" rel="nofollow">http://www.gnu.org/software/hurd/history.html</a>

10 プログラミングの自由同盟プレスリリースによれば、
この抗議行動は、十六進プロテスト数え唄が始めて歌われたことで著名である。

<blockquote><p class="quotation">1-2-3-4、弁護士はドアから外に放り出せ<br />
...
11 Reuven Lerner, &quot;Stallman wins $240,000 <span class="noexists">MacArthur<a href="http://haleakala-avenue.style.coocan.jp/lealea/?cmd=edit&amp;page=MacArthur&amp;refer=%E7%AC%AC%E4%B9%9D%E7%AB%A0%E3%80%80GPL">?</a></span>? award,&quot; MIT, The Tech (July 18, 1990). <a href="http://the-tech.mit.edu/V110/N30/rms.30n.html" rel="nofollow">http://the-tech.mit.edu/V110/N30/rms.30n.html</a>
を参照。
...
<a href="http://www.linuxjournal.com/article/2736" rel="nofollow">http://www.linuxjournal.com/article/2736</a>
