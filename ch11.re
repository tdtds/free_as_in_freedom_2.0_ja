...
自由ソフトウェアという大義の前進に積極的関心を持つ組織を率いるピーターソンは、別の用語を提案した。オープンソース（open source）である。

当時を振り返り、宣伝業界で働く友達とネットスケープの決定について議論している間にオープンソースという用語を思いついたとピーターソンは言う。その用語を思いついたのがどこからだったか別の分野から借りてきたのだったかは思い出せないが、その用語を友人が嫌ったことは覚えている。@<fn>{5}
